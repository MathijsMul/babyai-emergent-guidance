...
A platform for simulating language learning with a human in the loop, based on on-going research at [Mila](https://mila.quebec/en/).

It is extended with an agent that learns to guide other agents by means of discrete messages. The developed communication system is emergent and does not require additional supervision.
...
Install the current repository as editable.
